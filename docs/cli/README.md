...
| [`transact`](transact.md) | Transact with WHERE/DELETE/INSERT patterns |
...
Commands that accept data input (`insert`, `upsert`, `transact`, `query`) use flexible argument resolution:
