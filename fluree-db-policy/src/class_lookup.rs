...
use fluree_db_core::{
    range_with_overlay, Db, FlakeValue, NodeCache, OverlayProvider, RangeMatch, RangeOptions,
...
pub async fn lookup_subject_classes<S, C, O>(
    subjects: &[Sid],
    db: &Db<S, C>,
    overlay: &O,
    to_t: i64,
...
pub async fn populate_class_cache<S, C, O>(
    subjects: &[Sid],
    db: &Db<S, C>,
    overlay: &O,
    to_t: i64,
