...
mod tests {
    ...
    fn post_single_type_omits_o_type_column() {
        ...
        let enc = encode_leaflet_v3(&records, RunSortOrder::Post, 1);
    ...
    fn spot_includes_all_columns() {
        ...
        let enc = encode_leaflet_v3(&records, RunSortOrder::Spot, 1);
    ...
    fn opst_omits_o_type_column() {
        ...
        let enc = encode_leaflet_v3(&records, RunSortOrder::Opst, 1);
        assert_eq!(enc.o_type_const, Some(OType::XSD_INTEGER.as_u16()));
    ...
    fn lead_group_count_psot() {
        ...
        let enc = encode_leaflet_v3(&records, RunSortOrder::Psot, 1);
