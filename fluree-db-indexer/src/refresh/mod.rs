    ...
    C: NodeCache + Sync,
{
    ...
    .instrument(tracing::debug_span!("refresh_spot"));
    ...
    .instrument(tracing::debug_span!("refresh_psot"));
    ...
    .instrument(tracing::debug_span!("refresh_post"));
    ...
    .instrument(tracing::debug_span!("refresh_opst"));
    ...
    .instrument(tracing::debug_span!("refresh_tspo"));
    ...
    let garbage_ref = async {
        ...
        write_garbage_record(storage, alias, target_t, garbage_addresses).await
    }
    .instrument(tracing::debug_span!("gc_collect"))
    .await?;
