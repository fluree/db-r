...
// ============================================================================
// MergeInputV3 / MergeOutputV3
// ============================================================================

/// Input to the V3 novelty merge.
pub struct MergeInputV3<'a> {
...
pub fn merge_novelty_v3(input: &MergeInputV3<'_>) -> MergeOutputV3 {
...
/// leaflet data through `LeafWriterV3` after a merge.
...
mod tests {
    ...
    /// Helper: make a MergeInputV3 from existing records + novelty records + ops.
    fn make_input<'a>(
        batch: &'a ColumnBatch,
