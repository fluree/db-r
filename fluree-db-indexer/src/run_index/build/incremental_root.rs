...
impl IncrementalRootBuilder {
    ...
    pub fn set_graph_arenas(
        &mut self,
        arenas: Vec<fluree_db_binary_index::format::index_root::GraphArenaRefsV5>,
    ) {
...
mod tests {
    use super::*;
    use fluree_db_binary_index::format::index_root::DictPackRefs;
    use fluree_db_binary_index::format::index_root::DictTreeRefs;
