...
use crate::run_index::runs::streaming_reader_v2::MergeSourceV2;
...
pub struct KWayMergeV2<T: MergeSourceV2, F: Fn(&RunRecordV2, &RunRecordV2) -> Ordering> {
    heap: Vec<HeapEntry>,
    streams: Vec<T>,
    cmp: F,
}

impl<T: MergeSourceV2, F: Fn(&RunRecordV2, &RunRecordV2) -> Ordering> KWayMergeV2<T, F> {
...
mod tests {
    ...
    impl MergeSourceV2 for VecSource {
