...
pub use index_root::{
    parse_index_root, BinaryGarbageRef, BinaryIndexRoot, BinaryIndexRootAny, BinaryIndexRootV2,
    BinaryPrevIndexRef, DictAddresses, GraphAddresses, GraphEntry, GraphEntryV2,
    GraphOrderAddresses, BINARY_INDEX_ROOT_VERSION, BINARY_INDEX_ROOT_VERSION_V2,
};
...
/// ```
pub fn persist_namespaces(ns_prefixes: &HashMap<i32, String>, run_dir: &Path) -> io::Result<()> {
