...
async fn oidc_rs256_bearer_allows_read_and_write() {
    ...
    // Create ledger (no data auth on /fluree/create)
    let resp = app
        .clone()
        .oneshot(
            Request::builder()
