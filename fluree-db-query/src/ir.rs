...
impl std::fmt::Display for FunctionName {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            FunctionName::Substr => write!(f, "SUBSTR"),
            FunctionName::Ucase => write!(f, "UCASE"),
            FunctionName::Lcase => write!(f, "LCASE"),
            FunctionName::Contains => write!(f, "CONTAINS"),
            FunctionName::StrStarts => write!(f, "STRSTARTS"),
            FunctionName::StrEnds => write!(f, "STRENDS"),
            FunctionName::Regex => write!(f, "REGEX"),
            FunctionName::Concat => write!(f, "CONCAT"),
            FunctionName::StrBefore => write!(f, "STRBEFORE"),
            FunctionName::StrAfter => write!(f, "STRAFTER"),
            FunctionName::Replace => write!(f, "REPLACE"),
            FunctionName::Str => write!(f, "STR"),
            FunctionName::StrDt => write!(f, "STRDT"),
            FunctionName::StrLang => write!(f, "STRLANG"),
            FunctionName::EncodeForUri => write!(f, "ENCODE_FOR_URI"),
            FunctionName::Abs => write!(f, "ABS"),
            FunctionName::Round => write!(f, "ROUND"),
            FunctionName::Ceil => write!(f, "CEIL"),
            FunctionName::Floor => write!(f, "FLOOR"),
            FunctionName::Rand => write!(f, "RAND"),
            FunctionName::Power => write!(f, "POWER"),
            FunctionName::Iri => write!(f, "IRI"),
            FunctionName::Bnode => write!(f, "BNODE"),
            FunctionName::Now => write!(f, "NOW"),
            FunctionName::Year => write!(f, "YEAR"),
            FunctionName::Month => write!(f, "MONTH"),
            FunctionName::Day => write!(f, "DAY"),
            FunctionName::Hours => write!(f, "HOURS"),
            FunctionName::Minutes => write!(f, "MINUTES"),
            FunctionName::Seconds => write!(f, "SECONDS"),
            FunctionName::Tz => write!(f, "TZ"),
            FunctionName::IsIri => write!(f, "isIRI"),
            FunctionName::IsBlank => write!(f, "isBlank"),
            FunctionName::IsLiteral => write!(f, "isLiteral"),
            FunctionName::IsNumeric => write!(f, "isNumeric"),
            FunctionName::Lang => write!(f, "LANG"),
            FunctionName::Datatype => write!(f, "DATATYPE"),
            FunctionName::LangMatches => write!(f, "LANGMATCHES"),
            FunctionName::SameTerm => write!(f, "SAMETERM"),
            FunctionName::T => write!(f, "T"),
            FunctionName::Op => write!(f, "OP"),
            FunctionName::Md5 => write!(f, "MD5"),
            FunctionName::Sha1 => write!(f, "SHA1"),
            FunctionName::Sha256 => write!(f, "SHA256"),
            FunctionName::Sha384 => write!(f, "SHA384"),
            FunctionName::Sha512 => write!(f, "SHA512"),
            FunctionName::Uuid => write!(f, "UUID"),
            FunctionName::StrUuid => write!(f, "STRUUID"),
            FunctionName::DotProduct => write!(f, "dotProduct"),
            FunctionName::CosineSimilarity => write!(f, "cosineSimilarity"),
            FunctionName::EuclideanDistance => write!(f, "euclideanDistance"),
            FunctionName::Bound => write!(f, "BOUND"),
            FunctionName::If => write!(f, "IF"),
            FunctionName::Coalesce => write!(f, "COALESCE"),
