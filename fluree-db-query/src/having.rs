...
pub struct HavingOperator<S: Storage + 'static, C: NodeCache + 'static> {
...
impl<S: Storage + 'static, C: NodeCache + 'static> HavingOperator<S, C> {
...
#[async_trait]
impl<S: Storage + 'static, C: NodeCache + 'static> Operator<S, C> for HavingOperator<S, C> {
