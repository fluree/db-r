...
async fn test_group_by_with_having() {
    ...
    let options = QueryOptions::new()
        ...
        .with_having(FilterExpr::Compare {
            op: CompareOp::Gt,
...
async fn test_group_by_multiple_keys() {
    ...
    impl<S: fluree_db_core::Storage + 'static, C: fluree_db_core::NodeCache + 'static>
        fluree_db_query::operator::Operator<S, C> for BatchOperator
    {
    ...
    let child: fluree_db_query::operator::BoxedOperator<MemoryStorage, NoCache> =
